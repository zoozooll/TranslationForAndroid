...
public class XMLFactory {
	...
	public static synchronized XMLFactory instance() {
		if (instance == null) {
	...
	public void parse(String xmlPath, XMLNote note) throws DocumentException {
		parse(new File(xmlPath), note);
		
	}
	
	public void parse(File xmlPath, XMLNote note) throws DocumentException {
		Document doc = reader.read(xmlPath);
		treeWalk(doc, note);
	}
	
	public void treeWalk(Document document, XMLNote note) {
